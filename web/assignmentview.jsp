...
<body>
 ...
 <div class="para">
     <h1 style="padding-top: 25px; margin-bottom: -70px; color: #0e1f62; padding-left: 50px;">Assignment results</h1> 
 </div>                                              
<form method="post" name="frm" action="AssignmentSearch">
             <input  type="text" name="pid" id="pid" placeholder="Enter your student index number">
